...
abstract class fen_AdminPageFramework_CustomSubmitFields extends fen_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class fen_AdminPageFramework_ExportOptions extends fen_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo fen_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
