...
abstract class fen_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'fen_AdminPageFramework_Form_', 'oPageLoadInfo' => 'fen_AdminPageFramework_PageLoadInfo_', 'oResource' => 'fen_AdminPageFramework_Resource_', 'oHelpPane' => 'fen_AdminPageFramework_HelpPane_', 'oLink' => 'fen_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'fen_AdminPageFramework_Debug', 'oUtil' => 'fen_AdminPageFramework_FrameworkUtility', 'oMsg' => 'fen_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(fen_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return fen_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class fen_AdminPageFramework_Factory_Model extends fen_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class fen_AdminPageFramework_Factory_View extends fen_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new fen_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class fen_AdminPageFramework_Factory_Controller extends fen_AdminPageFramework_Factory_View {
...
abstract class fen_AdminPageFramework_Factory extends fen_AdminPageFramework_Factory_Controller {
}
