...
class fen_AdminPageFramework_Message {
    ...
    private function __doDummy() {
        ...
        __('Loading...', 'fen');
        __('Please enable JavaScript for better user experience.', 'fen');
        __('Debug', 'fen');
        __('Field Arguments', 'fen');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'fen');
        __('Section Arguments', 'fen');
        __('The ability to repeat sections is disabled.', 'fen');
        __('The ability to repeat fields is disabled.', 'fen');
        __('Warning.', 'fen');
    }
}
