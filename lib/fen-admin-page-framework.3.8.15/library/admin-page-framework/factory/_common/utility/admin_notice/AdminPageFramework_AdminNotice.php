...
class fen_AdminPageFramework_AdminNotice extends fen_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'fen-settings-notice-message', 'fen-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new fen_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
