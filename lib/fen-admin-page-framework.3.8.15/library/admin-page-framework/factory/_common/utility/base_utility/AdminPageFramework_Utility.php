...
abstract class fen_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        fen_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return fen_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        fen_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return fen_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        fen_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        fen_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        fen_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'fen_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class fen_AdminPageFramework_Utility_VariableType extends fen_AdminPageFramework_Utility_Deprecated {
...
abstract class fen_AdminPageFramework_Utility_String extends fen_AdminPageFramework_Utility_VariableType {
...
abstract class fen_AdminPageFramework_Utility_Array extends fen_AdminPageFramework_Utility_String {
...
abstract class fen_AdminPageFramework_Utility_ArrayGetter extends fen_AdminPageFramework_Utility_Array {
...
abstract class fen_AdminPageFramework_Utility_ArraySetter extends fen_AdminPageFramework_Utility_ArrayGetter {
...
abstract class fen_AdminPageFramework_Utility_Path extends fen_AdminPageFramework_Utility_ArraySetter {
...
abstract class fen_AdminPageFramework_Utility_URL extends fen_AdminPageFramework_Utility_Path {
...
abstract class fen_AdminPageFramework_Utility_File extends fen_AdminPageFramework_Utility_URL {
...
abstract class fen_AdminPageFramework_Utility_SystemInformation extends fen_AdminPageFramework_Utility_File {
...
abstract class fen_AdminPageFramework_Utility_HTMLAttribute extends fen_AdminPageFramework_Utility_SystemInformation {
...
class fen_AdminPageFramework_Utility extends fen_AdminPageFramework_Utility_HTMLAttribute {
