...
class fen_AdminPageFramework_Debug_Base extends fen_AdminPageFramework_FrameworkUtility {
...
class fen_AdminPageFramework_Debug_Log extends fen_AdminPageFramework_Debug_Base {
...
class fen_AdminPageFramework_Debug extends fen_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('fen_AdminPageFramework_Debug::' . __FUNCTION__, 'fen_AdminPageFramework_Debug::dump()');
        fen_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('fen_AdminPageFramework_Debug::' . __FUNCTION__, 'fen_AdminPageFramework_Debug::get()');
        return fen_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('fen_AdminPageFramework_Debug::' . __FUNCTION__, 'fen_AdminPageFramework_Debug::log()');
        fen_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('fen_AdminPageFramework_Debug::' . __FUNCTION__);
