...
class fen_AdminPageFramework_Form_View___Script_SectionTab extends fen_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.fen-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='fen-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
