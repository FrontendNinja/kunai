...
class fen_AdminPageFramework_Form_View___Script_SortableField extends fen_AdminPageFramework_Form_View___Script_Base {
    ...
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablefen_AdminPageFrameworkSortableFields = function( sFieldsContainerID ) {
...
class fen_AdminPageFramework_Form_View___Script_SortableSection extends fen_AdminPageFramework_Form_View___Script_SortableField {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function($) {
    $.fn.enablefen_AdminPageFrameworkSortableSections = function( sSectionsContainerID ) {
        ...
        var _bIsTabbed      = _oTarget.hasClass( 'fen-section-tabs-contents' );
        var _bCollapsible   = 0 < _oTarget.children( '.fen-section.is_subsection_collapsible' ).length;

        var _oTarget        = _bIsTabbed
            ? _oTarget.find( 'ul.fen-section-tabs' )
            : _oTarget;
        ...
        var _aSortableOptions = { 
                items: _bIsTabbed
                    ? '> li:not( .disabled )'
                    : '> div:not( .disabled, .fen-collapsible-toggle-all-button-container )', 
                ...
                // cancel: '.fen-section-description, .fen-section-title'
        ...
        if ( ! _bIsTabbed ) {
            ...
            _oSortable.bind( 'sortstop', function() {
                ...
                jQuery( this ).find( 'caption > .fen-section-title:not(.fen-collapsible-sections-title,.fen-collapsible-section-title)' ).first().show();
                jQuery( this ).find( 'caption > .fen-section-title:not(.fen-collapsible-sections-title,.fen-collapsible-section-title)' ).not( ':first' ).hide();
...
jQuery( document ).ready( function() {    
    jQuery( '#{$sContainerTagID}' ).enablefen_AdminPageFrameworkSortableSections( '{$sContainerTagID}' ); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='fen-section-sortable-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
