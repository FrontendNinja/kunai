...
class fen_AdminPageFramework_Form_View___FieldTitle extends fen_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_aLabelAttributes = array('class' => $this->getClassAttribute('fen-field-title', $this->aClassSelectors), 'for' => $_oInputTagIDGenerator->get(),);
    ...
    private function _getFieldOutputsInFieldTitleAreaFromNestedFields($aField) {
        ...
        foreach ($aField['content'] as $_aNestedField) {
            ...
            $_oFieldset = new fen_AdminPageFramework_Form_View___Fieldset($_aNestedField, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
    ...
    private function _getDebugInfo($aField) {
        ...
        $_oToolTip = new fen_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('field_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => fen_AdminPageFramework_Debug::getDetails($aField) . '<span class="fen-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aField['field_id'] . '_debug');
        return $_oToolTip->get();
    }
