...
class fen_AdminPageFramework_Form_View__Resource__Head extends fen_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    public function _replyToInsertRequiredInternalScripts() {
        ...
        echo "<script type='text/javascript' class='fen-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'fen-js-embedded-internal-style\'>' . str_replace('\\n', '', esc_js($this->_getInternalCSS())) . '</style>" );';
    }
    private function _getInternalCSS() {
        $_oLoadingCSS = new fen_AdminPageFramework_Form_View___CSS_Loading;
    ...
    private function _getScriptElementConcealerCSSRules() {
        return ".fen-form-js-on {visibility: hidden;}.widget .fen-form-js-on { visibility: visible; }";
    }
}
