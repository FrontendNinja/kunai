...
class fen_AdminPageFramework_FieldType_submit extends fen_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".fen-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'fen-input-label-container' . ' fen-input-button-container' . ' fen-input-container',);
    }
...
class fen_AdminPageFramework_FieldType_export extends fen_AdminPageFramework_FieldType_submit {
