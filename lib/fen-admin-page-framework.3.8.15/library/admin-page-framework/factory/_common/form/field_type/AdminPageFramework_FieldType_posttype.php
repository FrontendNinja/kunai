...
class fen_AdminPageFramework_FieldType_checkbox extends fen_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.fen-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.fen-checkbox-label {margin-top: 0.1em;}.fen-field input[type='checkbox' ] {margin-right: 0.5em;} .fen-field-checkbox .fen-input-label-container {padding-right: 1em;}.fen-field-checkbox .fen-input-label-string{display: inline; }";
    }
...
class fen_AdminPageFramework_FieldType_posttype extends fen_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".fen-field input[type='checkbox'] {margin-right: 0.5em;} .fen-field-posttype .fen-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
