...
class fen_AdminPageFramework_Form_View extends fen_AdminPageFramework_Form_Model {
    ...
    public function get() {
        ...
        $_oFormTables = new fen_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->callBack($this->aCallbacks['field_errors'], array($this->getFieldErrors())), $this->aCallbacks, $this->oMsg);
...
class fen_AdminPageFramework_Form extends fen_AdminPageFramework_Form_Controller {
    ...
    public $oFieldError;
    public $oLastInputs;
    public $aSubClasses = array('submit_notice' => 'fen_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'fen_AdminPageFramework_Form___FieldError', 'last_input' => 'fen_AdminPageFramework_Form_Model___LastInput', 'message' => 'fen_AdminPageFramework_Message',);
    public function __construct() {
