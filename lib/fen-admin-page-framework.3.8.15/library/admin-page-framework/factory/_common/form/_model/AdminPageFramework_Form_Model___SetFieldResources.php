...
class fen_AdminPageFramework_Form_Model___SetFieldResources extends fen_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new fen_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('fen_AdminPageFramework_Form_View___CSS_Form', 'fen_AdminPageFramework_Form_View___CSS_Field', 'fen_AdminPageFramework_Form_View___CSS_Section', 'fen_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'fen_AdminPageFramework_Form_View___CSS_FieldError', 'fen_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('fen_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new fen_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new fen_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
