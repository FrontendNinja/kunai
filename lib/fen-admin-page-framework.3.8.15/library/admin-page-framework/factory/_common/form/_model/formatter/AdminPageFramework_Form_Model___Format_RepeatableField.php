...
class fen_AdminPageFramework_Form_Model___Format_RepeatableSection extends fen_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : fen_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class fen_AdminPageFramework_Form_Model___Format_RepeatableField extends fen_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
