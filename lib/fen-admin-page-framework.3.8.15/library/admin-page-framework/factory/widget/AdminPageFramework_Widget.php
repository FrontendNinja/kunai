...
abstract class fen_AdminPageFramework_Widget_Router extends fen_AdminPageFramework_Factory {
...
abstract class fen_AdminPageFramework_Widget_Model extends fen_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new fen_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class fen_AdminPageFramework_Widget_View extends fen_AdminPageFramework_Widget_Model {
...
abstract class fen_AdminPageFramework_Widget_Controller extends fen_AdminPageFramework_Widget_View {
...
abstract class fen_AdminPageFramework_Widget extends fen_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'fen') {
