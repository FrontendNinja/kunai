(function ($) {
    jQuery( document ).ready( function(){
        ...
        var _initializeNoUISliders = function( nodeThis ) {
            ...
            var _oTargetSlider = jQuery( nodeThis ).closest( '.fen-field' )
            ...
            initializeNoUISlider(
                jQuery( nodeThis ).closest( '.fen-field' )
                    .children( '.no-ui-sliders' )
                    .first().get( 0 )
            );
        ...
        jQuery( 'input[data-type=no_ui_slider][data-interactive=1]' ).on( 'change', function(){
            ...
            var _oTargetSlider    = jQuery( this ).closest( '.fen-field' )
                .children( '.no-ui-sliders' )
                .first();
            ...
            function _setEmptyInputValues( nodeInput, aValues ) {
                ...
                jQuery( nodeInput ).closest( '.fen-field' ).children( '.fen-input-label-container' )
            ...
            function _getInputValuesSanitized( aValues, nodeInput ) {
                ...
                var _aValues = [];
                var _aRange  = jQuery( nodeInput ).closest( '.fen-field' ).children( '.no-ui-sliders' )
                    .first()
                    .data( 'range' );
