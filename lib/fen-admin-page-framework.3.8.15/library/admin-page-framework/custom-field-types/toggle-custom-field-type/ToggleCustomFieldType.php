...
if ( ! class_exists( 'fen_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class fen_ToggleCustomFieldType extends fen_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.fen-field' )
                    .children( '.fen-checkbox-container-toggle' )
                    .hide();
