...
if ( ! class_exists( 'fen_PathCustomFieldType' ) ) :
/**
 ...
 */
class fen_PathCustomFieldType extends fen_AdminPageFramework_FieldType_image {
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='fen-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setfen_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='fen-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
