<?php
if ( ! class_exists( 'fen_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class fen_GitHubCustomFieldType extends fen_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            ...
            . "<div class='fen-input-label-container'>"        
                ...
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='fen-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'fen' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'fen' );
                case 'star':
                    return __( 'Star', 'fen' );
