...
if ( ! class_exists( 'fen_Select2CustomFieldType' ) ) :
/**
 ...
 */
class fen_Select2CustomFieldType extends fen_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.fen-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.fen-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.fen-select-label' )
                .children( 'label' )
                .children( '.fen-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.fen-field' )
    ...
    protected function getStyles() {
        return "
.fen-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}
...
.repeatable .fen-field-select2 > .fen-select-label > label > .fen-input-container {
    max-width: 84%;
}
