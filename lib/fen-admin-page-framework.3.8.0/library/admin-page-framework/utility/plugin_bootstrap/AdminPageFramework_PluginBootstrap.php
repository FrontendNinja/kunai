...
abstract class fen_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('fen_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new fen_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
