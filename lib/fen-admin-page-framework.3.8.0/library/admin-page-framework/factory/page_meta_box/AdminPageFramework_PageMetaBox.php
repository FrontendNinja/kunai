...
abstract class fen_AdminPageFramework_PageMetaBox_Router extends fen_AdminPageFramework_MetaBox_View {
...
abstract class fen_AdminPageFramework_PageMetaBox_Model extends fen_AdminPageFramework_PageMetaBox_Router {
...
abstract class fen_AdminPageFramework_PageMetaBox_View extends fen_AdminPageFramework_PageMetaBox_Model {
}
abstract class fen_AdminPageFramework_PageMetaBox_Controller extends fen_AdminPageFramework_PageMetaBox_View {
...
abstract class fen_AdminPageFramework_PageMetaBox extends fen_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'fen') {
