...
class fen_AdminPageFramework_Form_View___DebugInfo extends fen_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='fen-info'>" . $this->oMsg->get('debug_info') . ': ' . fen_AdminPageFramework_Registry::NAME . ' ' . fen_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}
