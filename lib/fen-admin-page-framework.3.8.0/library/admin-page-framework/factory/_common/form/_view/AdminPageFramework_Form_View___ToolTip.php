...
class fen_AdminPageFramework_Form_View___ToolTip extends fen_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return '' . "<a href='{$_sHref}' class='fen-form-tooltip'>" . $this->_getTipLinkIcon() . "<span class='fen-form-tooltip-content'>" . $this->_getTipTitle() . $this->_getDescriptions() . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span class='fen-form-tool-tip-title'>" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='fen-form-tool-tip-description'>" . implode("</span><span class='fen-form-tool-tip-description'>", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
}
