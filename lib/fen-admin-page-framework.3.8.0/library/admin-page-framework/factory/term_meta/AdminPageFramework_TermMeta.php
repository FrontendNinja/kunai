...
abstract class fen_AdminPageFramework_TermMeta_Router extends fen_AdminPageFramework_TaxonomyField_Controller {
}
abstract class fen_AdminPageFramework_TermMeta_Model extends fen_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new fen_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class fen_AdminPageFramework_TermMeta_View extends fen_AdminPageFramework_TermMeta_Model {
...
abstract class fen_AdminPageFramework_TermMeta_Controller extends fen_AdminPageFramework_TermMeta_View {
}
abstract class fen_AdminPageFramework_TermMeta extends fen_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'fen') {
