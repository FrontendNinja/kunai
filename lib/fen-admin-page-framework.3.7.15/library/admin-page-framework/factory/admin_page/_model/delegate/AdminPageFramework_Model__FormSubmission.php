...
abstract class fen_AdminPageFramework_Model__FormSubmission_Base extends fen_AdminPageFramework_FrameworkUtility {
...
class fen_AdminPageFramework_Model__FormSubmission extends fen_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new fen_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new fen_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
