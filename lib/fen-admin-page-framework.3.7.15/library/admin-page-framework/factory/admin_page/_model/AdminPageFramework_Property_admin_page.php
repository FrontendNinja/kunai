...
class fen_AdminPageFramework_Property_admin_page extends fen_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'fen') {
        ...
        $GLOBALS['afen_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('afen_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['afen_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
