...
class fen_AdminPageFramework_WPUtility_URL extends fen_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(fen_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(fen_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = fen_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class fen_AdminPageFramework_WPUtility_HTML extends fen_AdminPageFramework_WPUtility_URL {
...
class fen_AdminPageFramework_WPUtility_Page extends fen_AdminPageFramework_WPUtility_HTML {
...
class fen_AdminPageFramework_WPUtility_Hook extends fen_AdminPageFramework_WPUtility_Page {
...
class fen_AdminPageFramework_WPUtility_File extends fen_AdminPageFramework_WPUtility_Hook {
...
class fen_AdminPageFramework_WPUtility_Option extends fen_AdminPageFramework_WPUtility_File {
...
class fen_AdminPageFramework_WPUtility_Meta extends fen_AdminPageFramework_WPUtility_Option {
...
class fen_AdminPageFramework_WPUtility_SiteInformation extends fen_AdminPageFramework_WPUtility_Meta {
...
class fen_AdminPageFramework_WPUtility_SystemInformation extends fen_AdminPageFramework_WPUtility_SiteInformation {
...
class fen_AdminPageFramework_WPUtility extends fen_AdminPageFramework_WPUtility_SystemInformation {
