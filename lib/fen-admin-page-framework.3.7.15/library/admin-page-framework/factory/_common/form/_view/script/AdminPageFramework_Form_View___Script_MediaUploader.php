...
class fen_AdminPageFramework_Form_View___Script_MediaUploader extends fen_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getfen_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
