...
class fen_AdminPageFramework_Form_View___Generate_FieldTagID extends fen_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class fen_AdminPageFramework_Form_View___Generate_FieldInputID extends fen_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
