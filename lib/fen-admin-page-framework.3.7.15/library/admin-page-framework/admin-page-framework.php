...
if (!class_exists('fen_AdminPageFramework_Registry', false)):
    abstract class fen_AdminPageFramework_Registry_Base {
    ...
    final class fen_AdminPageFramework_Registry extends fen_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['fen_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['fen_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('fen_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['fen_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('fen_AdminPageFramework_Bootstrap', false)):
    final class fen_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            fen_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (fen_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (fen_AdminPageFramework_Registry::$sAutoLoaderPath);
            new fen_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('fen_AdminPageFramework_MinifiedVersionHeader', 'fen_AdminPageFramework_BeautifiedVersionHeader',),), fen_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new fen_AdminPageFramework_Utility;
                new fen_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new fen_AdminPageFramework_Bootstrap(__FILE__);
endif;
