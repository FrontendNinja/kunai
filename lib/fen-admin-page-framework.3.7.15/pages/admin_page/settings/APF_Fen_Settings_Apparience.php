  ...
  public function replyToLoadTab( $oAdminPage ) {
    ...
    $oAdminPage->addSettingFields(
      ...
      array(
        ...
        'attributes'    => array(
          'placeholder' => __( '20% OFF SITEWIDE + FREE SHIPPING <br> CODE: DAYOFF   |   ENDS 5/31   |   SHOP NOW', 'admin-page-framework' ),
          'size'      => 90,
        ),
      ),
      array(
      ...
      array(
        'field_id'          => 'header-alert',
        'type'              => 'textarea',
        'title'             => __( '<strong>Texto en el Header:</strong>', 'admin-page-framework' ),
        'description'       => __( 'Éste es el texto que aparece en la parte superior izquierda del header.', 'admin-page-framework' ),
        'tip'               => __( 'Incluye la etiqueta "< br>" para agregar un "enter" al título. <br>Deja vacío el campo para no mostrar nada.', 'admin-page-framework' ),
        'default'           => __( 'Teavana no es franquiciable', 'admin-page-framework' ),
        'attributes'    => array(
          'placeholder' => __( 'Teavana no es franquiciable', 'admin-page-framework' ),
          'size'      => 90,
        ),
      )
    );
