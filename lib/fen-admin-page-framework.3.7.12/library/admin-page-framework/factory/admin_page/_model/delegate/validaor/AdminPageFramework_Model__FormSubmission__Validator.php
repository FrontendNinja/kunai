...
class fen_AdminPageFramework_Model__FormSubmission__Validator_Base extends fen_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class fen_AdminPageFramework_Model__FormSubmission__Validator extends fen_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('fen_AdminPageFramework_Model__FormSubmission__Validator__Link', 'fen_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'fen_AdminPageFramework_Model__FormSubmission__Validator__Import', 'fen_AdminPageFramework_Model__FormSubmission__Validator__Export', 'fen_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'fen_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'fen_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'fen_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new fen_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
