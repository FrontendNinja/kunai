...
abstract class fen_AdminPageFramework_TaxonomyField_Router extends fen_AdminPageFramework_Factory {
...
abstract class fen_AdminPageFramework_TaxonomyField_Model extends fen_AdminPageFramework_TaxonomyField_Router {
...
abstract class fen_AdminPageFramework_TaxonomyField_View extends fen_AdminPageFramework_TaxonomyField_Model {
...
abstract class fen_AdminPageFramework_TaxonomyField_Controller extends fen_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class fen_AdminPageFramework_TaxonomyField extends fen_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'fen') {
