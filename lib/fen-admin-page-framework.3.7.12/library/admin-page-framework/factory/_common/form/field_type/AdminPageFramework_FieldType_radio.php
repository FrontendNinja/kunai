...
class fen_AdminPageFramework_FieldType_radio extends fen_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".fen-field input[type='radio'] {margin-right: 0.5em;} .fen-field-radio .fen-input-label-container {padding-right: 1em;} .fen-field-radio .fen-input-container {display: inline;} .fen-field-radio .fen-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.fen-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
