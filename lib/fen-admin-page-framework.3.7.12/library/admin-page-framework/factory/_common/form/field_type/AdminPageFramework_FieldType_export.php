...
class fen_AdminPageFramework_FieldType_submit extends fen_AdminPageFramework_FieldType {
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'fen-input-label-container' . ' fen-input-button-container' . ' fen-input-container',);
    }
