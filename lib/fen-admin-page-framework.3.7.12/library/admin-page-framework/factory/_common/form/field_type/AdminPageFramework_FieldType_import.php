...
class fen_AdminPageFramework_FieldType_import extends fen_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".fen-field-import input {margin-right: 0.5em;}.fen-field-import label,.form-table td fieldset.fen-fieldset .fen-field-import label { display: inline; }";
    }
