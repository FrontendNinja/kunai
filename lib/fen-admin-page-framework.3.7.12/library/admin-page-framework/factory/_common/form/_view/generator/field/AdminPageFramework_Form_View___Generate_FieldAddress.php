...
abstract class fen_AdminPageFramework_Form_View___Generate_Field_Base extends fen_AdminPageFramework_Form_View___Generate_Section_Base {
...
class fen_AdminPageFramework_Form_View___Generate_FieldName extends fen_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class fen_AdminPageFramework_Form_View___Generate_FlatFieldName extends fen_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class fen_AdminPageFramework_Form_View___Generate_FieldAddress extends fen_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
