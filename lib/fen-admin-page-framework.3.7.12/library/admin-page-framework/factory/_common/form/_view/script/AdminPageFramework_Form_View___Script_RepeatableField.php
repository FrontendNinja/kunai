...
(function ( $ ) {
    ...
    $.fn.updatefen_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        if ( ! $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( sFieldsContainerID ) ) {     
            $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ] = $.extend({    
        ...
        var _aOptions = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ];
        ...
        var _nCurrentFieldCount = jQuery( '#' + sFieldsContainerID ).find( '.fen-field' ).length;
    ...
    $.fn.addfen_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( ! $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( sFieldsContainerID ) ) {     
            ...
            $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ] = {    
        ...
        var _iFadein  = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadein' ];
        var _iFadeout = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ];

        // Show a warning message if the user tries to add more fields than the number of allowed fields.
        var sMaxNumberOfFields = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ]['max'];
    ...
    $.fn.removefen_AdminPageFrameworkRepeatableField = function() {
        ...
        var sMinNumberOfFields  = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'min' ];
        if ( sMinNumberOfFields != 0 && nodeFieldsContainer.find( '.fen-field' ).length <= sMinNumberOfFields ) {
            ...
            var _iFadeout = $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ]
                ? $.fn.afen_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ]
                : 500;
            nodeMessage.delay( 2000 ).fadeOut( _iFadeout );
            return;     
        }     
