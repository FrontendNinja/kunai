...
abstract class fen_AdminPageFramework_Form_View___Attribute_Base extends fen_AdminPageFramework_FrameworkUtility {
    public $sContext = '';
...
class fen_AdminPageFramework_Form_View___Attribute_Field extends fen_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    ...
    protected function _getAttributes() {
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "fen-field fen-field-" . $this->aArguments['type'] . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' fen-subfield', ''));
    }
}
