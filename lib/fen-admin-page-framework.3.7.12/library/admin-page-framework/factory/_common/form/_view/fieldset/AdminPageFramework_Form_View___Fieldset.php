...
abstract class fen_AdminPageFramework_Form_View___Fieldset_Base extends fen_AdminPageFramework_FrameworkUtility {
    public $aField = array();
...
jQuery( document ).ready( function() {
    ...
    /* Otherwise, insert the button element at the beginning of the field tag */
        ...
        if ( ! jQuery( '#{$sFieldsContainerID} .fen-repeatable-field-buttons' ).length ) { 
            // Adds the buttons
            jQuery( '#{$sFieldsContainerID} .fen-field' ).prepend( $_sButtonsHTML ); 
        }
    }     
...
class fen_AdminPageFramework_Form_View___Fieldset extends fen_AdminPageFramework_Form_View___Fieldset_Base {
    public function get() {
        $_aOutputs = array();
        $_oFieldError = new fen_AdminPageFramework_Form_View___Fieldset___FieldError($this->aErrors, $this->aField['_section_path_array'], $this->aField['_field_path_array'], $this->aField['error_message']);
        $_aOutputs[] = $_oFieldError->get();
        $_oFieldsFormatter = new fen_AdminPageFramework_Form_Model___Format_Fields($this->aField, $this->aOptions);
