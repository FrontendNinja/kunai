...
abstract class fen_AdminPageFramework_MetaBox_Router extends fen_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'fen') {
...
abstract class fen_AdminPageFramework_MetaBox_Model extends fen_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'fen') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new fen_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class fen_AdminPageFramework_MetaBox_View extends fen_AdminPageFramework_MetaBox_Model {
...
abstract class fen_AdminPageFramework_MetaBox_Controller extends fen_AdminPageFramework_MetaBox_View {
...
abstract class fen_AdminPageFramework_MetaBox extends fen_AdminPageFramework_MetaBox_Controller {
