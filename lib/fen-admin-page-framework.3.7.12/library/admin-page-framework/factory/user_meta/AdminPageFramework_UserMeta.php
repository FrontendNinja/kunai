...
abstract class fen_AdminPageFramework_UserMeta_Router extends fen_AdminPageFramework_Factory {
...
abstract class fen_AdminPageFramework_UserMeta_Model extends fen_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new fen_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class fen_AdminPageFramework_UserMeta_View extends fen_AdminPageFramework_UserMeta_Model {
...
abstract class fen_AdminPageFramework_UserMeta_Controller extends fen_AdminPageFramework_UserMeta_View {
...
abstract class fen_AdminPageFramework_UserMeta extends fen_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'fen') {
