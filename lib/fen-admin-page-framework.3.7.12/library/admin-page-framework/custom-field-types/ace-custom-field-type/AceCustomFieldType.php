<?php
/**
 * fen_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'fen_AceCustomFieldType' ) ) :
class fen_AceCustomFieldType extends fen_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.fen-field' ).nextAll().andSelf().each( function( iIndex ) {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField['before_label']
            . "<div class='fen-input-label-container'>"
