...
class acf_code_field extends acf_field {
	...
	*/
	...
	function render_field( $field ) {
		...
		$dir = get_stylesheet_directory_uri() . "/includes/admin-page/library/acf-code-field/";
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'codemirror-monokai', "{$dir}js/" . ACFCF_CODEMIRROR_VERSION . "/theme/monokai.css" );
	}
