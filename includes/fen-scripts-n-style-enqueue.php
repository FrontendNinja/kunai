...
function fen_enqueue_scripts(){
  ...
  wp_enqueue_script( 'fen-application',  get_template_directory_uri(). '/assets/javascripts/min/application-min.js', array('jquery'), null ); // Load Boostrap scripts with Codekit inside application.js for better performance.
}
